          ...
          <Grid container spacing={3} alignItems="start">
            ...
            >
              ...
              >
                ...
                >
                  <option value="electronics">Select patient name</option>
                  <option value="electronics">Alex</option>
                  <option value="gadget">Jhon</option>
                  <option value="shoes">Drek</option>
                </TextField>
              </Grid>
              ...
              <Grid size={12}>
                <TextField fullWidth label="Description" multiline rows={9} />
              </Grid>
            </Grid>
