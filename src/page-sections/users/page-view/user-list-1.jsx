  ...
  return <div className="pt-2 pb-4">
      <Card>
        <Box px={2} pt={2}>
          ...
          <SearchArea value={userFilter.search} gridRoute="/dashboard/patient-grid-list" listRoute="/dashboard/patient-list" onChange={e => handleChangeFilter('search', e.target.value)} />
        </Box>
